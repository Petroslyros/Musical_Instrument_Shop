...
import com.example.musicalinstrumentstore.ui.auth.adapter.InstrumentsAdapter
        ...
        addItemBtn.setOnClickListener {
            ...
            lifecycleScope.launch {
                ...
                try {
                    ...
                    Toast.makeText(this@ProductsActivity,"Something went wrong",Toast.LENGTH_SHORT).show()
                }
            }
        }
