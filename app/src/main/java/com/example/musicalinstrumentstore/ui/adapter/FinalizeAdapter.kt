...
class FinalizeAdapter (private val context: Context,
private val instruments: ArrayList<CartInstrument>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        val view = convertView ?: LayoutInflater.from(context)
            .inflate(R.layout.finalize_product_view, parent, false)
